...
class PopularDocumentsSettings extends Controller
{
    public function index()
    {
        $breadcrumb = [
            __('Dashboard') => route('admin.index'),
            __('Page Settings') . ' : ' . __('Top Documents') => '',
        ];

        $settings = new Settings('popular-documents');

        return view('admin.settings.pages.popular-documents', compact('breadcrumb', 'settings'));
    }
